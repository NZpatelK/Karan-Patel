...
const AboutMe: React.FC = () => {
    ...
    return (
        <div className='about-me-section'>
            ...
            {isMobile ?
                <p>
                    I am a recent graduate from AUT with a Bachelor&apos;s degree in Computer and Information Science,
                     specialising in software development. Through internships at Kara Technologies and UiRev,
                      I&apos;ve refined my skills as a Database Technician and Junior Developer. My passion lies in frontend, web, and mobile development,
                       along with UI/UX design. Beyond tech, I enjoy hiking, watching films, and exploring diverse cuisines. With an open mind and a hunger for learning, 
